...
def page_lessons():
    ...
    with st.container():
        st.markdown(
            ...
            • v = u + at (velocity with constant acceleration)<br>
            • s = ut + ½at² (displacement with constant acceleration)<br>
            ...
            • Final velocity: v = 0 + 3(5) = <b>15 m/s</b> (54 km/h)<br>
